...
[![Release](https://img.shields.io/badge/Release-v6.50.24-green.svg)](https://github.com/PlusOne/dbbackup/releases/latest)
...
```bash
# Linux x86_64
wget https://git.uuxo.net/UUXO/dbbackup/releases/download/v6.50.24/dbbackup-linux-amd64
chmod +x dbbackup-linux-amd64
