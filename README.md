...
[![Release](https://img.shields.io/badge/Release-v5.8.59-green.svg)](https://git.uuxo.net/UUXO/dbbackup/releases/latest)
...
```bash
# Linux x86_64
wget https://git.uuxo.net/UUXO/dbbackup/releases/download/v5.8.59/dbbackup-linux-amd64
chmod +x dbbackup-linux-amd64
